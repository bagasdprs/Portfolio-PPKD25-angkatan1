                                ...
                                <table class="table table-bordered text-center" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $no++ ?></td>
                                                <td><?= $row['start_year'] . " - " . $row['last_year'] ?></td>
                                                <td><?= $row['skill'] ?></td>
                                                <td><?= $row['agency'] ?></td>
                                                <td><?= $row['description'] ?></td>
                                                <td>
                                                    <a href="add_edit_resume.php?idEdit=<?= $row['id'] ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <a href="?idDel=<?= $row['id'] ?>" onclick="return confirm('Are u sure delete this one?')" class="btn btn-danger btn-sm">Delete</a>
                                                    <a target="_blank" href="print-pdf.php?idPrint=<?= $row['id'] ?>" class="btn btn-primary btn-sm">Print PDF</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
