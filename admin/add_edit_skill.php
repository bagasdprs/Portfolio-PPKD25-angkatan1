...
if (isset($_GET['idEdit'])) {
    $id = $_GET['idEdit'];
    $qEdit = mysqli_query($conn, "SELECT * FROM skills WHERE id = $id");
...
if (isset($_POST['edit'])) {
    ...
    $qUpdate = mysqli_query($conn, "UPDATE skills SET skill_name = '$skills', percentage = '$percentage' WHERE id = $id");
    if ($qUpdate) {
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><?= isset($_GET['idEdit']) ? 'EDIT SKILLS' : 'ADD' ?></h5>
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="percentage" value="<?= isset($_GET['idEdit']) ? $row['percentage'] : '' ?>"
                                            required>
                                    </div>
                                </div>
