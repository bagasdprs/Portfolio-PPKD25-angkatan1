...
if (isset($_POST['save'])) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO resume (start_year, last_year, skill, agency, description) VALUES ('$start_year', '$last_year', '$skill', '$agency', '$description')");
    if ($insert) {
...
if (isset($_POST['edit'])) {
    ...
    $qUpdate = mysqli_query($conn, "UPDATE resume SET start_year='$start_year', last_year='$last_year', skill='$skill', agency='$agency', description='$description' WHERE id = $id");
    if ($qUpdate) {
        header("location:resume.php");
    } else {
        header("location:add_edit_resume.php");
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="1800" max="3000" step="1" class="form-control" name="start_year" value="<?= isset($_GET['idEdit']) ? $row['start_year'] : date('Y') ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="1800" max="3000" step="1" class="form-control" name="last_year" value="<?= isset($_GET['idEdit']) ? $row['last_year'] : date('Y') ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="skill" value="<?= isset($_GET['idEdit']) ? $row['skill'] : '' ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="agency" value="<?= isset($_GET['idEdit']) ? $row['agency'] : '' ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control" cols="30" rows="8" value="<?= isset($_GET['idEdit']) ? $row['description'] : '' ?>"></textarea>
                                    </div>
                                </div>
